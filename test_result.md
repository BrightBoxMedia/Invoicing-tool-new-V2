...
## agent_communication:
    ...
    - agent: "main"
    - message: "Phase 1 COMPLETED: Successfully implemented frontend UI for enhanced invoice creation features: 1) Tax/Without Tax options for Proforma invoices with conditional UI, 2) Payment terms input field with default placeholder, 3) Advance received input with net amount calculation. All features integrated with existing backend APIs. Ready for testing."
    - agent: "testing"
